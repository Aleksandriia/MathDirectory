	...
	<header id="main-nav">
		<div class="container">
			...
			<div id="slide_out_menu">
				...
				<div class="logo"><img style="width: 50px;" src="images/logo3.png" alt=""></div>
				<ul>
					<li><a href="index1.html">Главная</a></li>
					<li><a href="index_autorizatia.html">Авторизация</a></li>
					<li><a href="index_olimpiad.html">Мои олимпиады</a></li>
			...
			<div class="row">
				...
				<div class="col-md-4 text-center">
					<a href="#" class="logo"><img style="width: 75px; margin-top: -40px;" src="images/logo3.png"
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center">
					<h1 class="wow fadeInUp">Прошел олимпиаду?</h1>
					<p class="wow fadeInUp" data-wow-delay=".2s">Введи данные о пройденной олимпиаде и она отобразится
						у преподавателя!</p>
					<!--
					<a href="#" class="btn btn-lg video-btn wow fadeInUp lightbox mfp-iframe"
						data-wow-delay=".3s" data-effect="mfp-zoom-in"><i class="fa fa-play"></i> Watch Video</a> -->
				</div>
		...
		<div class="container footer-container">
			<div class="row">
				<div class="col-md-3">
					...
					<a href="#" class="app_download"><img src="images/download.svg" alt=""></a>
					<ul class="socials">
						<li><a href="#"><i class="fa fa-twitter"></i></a></li>
						<li><a href="#"><i class="fa fa-facebook"></i></a></li>
						<li><a href="#"><i class="fa fa-google-plus"></i></a></li>
